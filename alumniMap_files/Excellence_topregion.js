...
jQuery(document).ready(function($) {
	...
	if(!Drupal.settings.Excellence.blockdemo){
		$('#topBar').hide();
	}
	
	// set the right text in the blcok demo page
	if(Drupal.settings.Excellence.blockdemo){
		$('#topBarLink a').text("↑ " + Drupal.settings.Excellence.bartext2 + "");
	}
	
	// Make the spy effect
	$('#topBarLink a').live('mouseover mouseout', function(event) {
    if (event.type == 'mouseover' && $(this).text() == "↓ " + Drupal.settings.Excellence.bartext + "") {
      $('#topBarLink').animate({
        'padding-top':'5px'
      });
    }
    else if (event.type == 'mouseout' && $(this).text() == "↓ " + Drupal.settings.Excellence.bartext + "") {
    $('#topBarLink').animate({
      'padding-top':'0px'
    });
    }
    ...
    if ($(this).text()=="↓ " + Drupal.settings.Excellence.bartext + "") {
      $(this).text("↑ " + Drupal.settings.Excellence.bartext2 + "");
      $(this).attr('title','Close this region');
    }
    else if ($(this).text()=="↑ " + Drupal.settings.Excellence.bartext2 + "") {
      $(this).text("↓ " + Drupal.settings.Excellence.bartext + "");
